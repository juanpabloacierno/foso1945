...
custom_font = pygame.font.Font(ASSETS_PATH + "imagine_font.ttf", 18)
white = (255, 255, 255)
light_grey = (191, 191, 191)
gold = (255, 215, 0)

# LOAD GRAPHICS
sprite_sheet_file = ASSETS_PATH + "1945_sprite_sheet.png"
...
menu_graphic = ASSETS_PATH + "menu.png"
water_bg = ASSETS_PATH + "waterbgext.png"
...
# LOAD SOUNDS
fusion_snd = pygame.mixer.Sound(ASSETS_PATH + "fusion.ogg")
shot_snd = pygame.mixer.Sound(ASSETS_PATH + "shot.ogg")
thump_snd = pygame.mixer.Sound(ASSETS_PATH + "thump.ogg")
cannon_snd = pygame.mixer.Sound(ASSETS_PATH + "cannon.ogg")
start_snd = pygame.mixer.Sound(ASSETS_PATH + "start.ogg")
pygame.mixer.music.load(ASSETS_PATH + "music_1.ogg")
play_musc = 1
